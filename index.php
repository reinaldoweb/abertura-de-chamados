...
?>  
    <div class="container"> 
      ...
      <div class="jumbotron">
        <h1>Sistema de atendimento ao usuário</h1>
        ...
        <p><a class="btn btn-lg btn-success" href="abrir_chamado.php" role="button"><span class="glyphicon glyphicon-edit"></span>Abra seu chamado</a>
